...
async function main() {
    ...
    const ownerPassword = await (0, bcryptjs_1.hash)('owner123', 12);
    const ceoPassword = await (0, bcryptjs_1.hash)('ceo123', 12);
    const directorPassword = await (0, bcryptjs_1.hash)('director123', 12);
    const leader1Password = await (0, bcryptjs_1.hash)('leader1123', 12);
    const leader2Password = await (0, bcryptjs_1.hash)('leader2123', 12);
    const memberPassword = await (0, bcryptjs_1.hash)('member123', 12);
    // Owner
